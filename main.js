...
var author$project$Main$Page1Msg = function (a) {
	return {$: 'Page1Msg', a: a};
};
var author$project$Main$Page2 = function (a) {
	return {$: 'Page2', a: a};
};
var author$project$Main$Page2Msg = function (a) {
	return {$: 'Page2Msg', a: a};
};
...
var author$project$Main$transitTo = F3(
	function (toMainModel, toMainMsg, _n0) {
		var destModel = _n0.a;
		var destMsg = _n0.b;
		return _Utils_Tuple2(
			toMainModel(destModel),
			A2(elm$core$Platform$Cmd$map, toMainMsg, destMsg));
	});
var author$project$Page1$Model = F2(
	function (key, message) {
		return {key: key, message: message};
	});
var elm$json$Json$Encode$string = _Json_wrap;
var author$project$Ports$ping = _Platform_outgoingPort('ping', elm$json$Json$Encode$string);
var author$project$Page1$init = function (key) {
	return _Utils_Tuple2(
		A2(author$project$Page1$Model, key, elm$core$Maybe$Nothing),
		author$project$Ports$ping('Page1'));
};
var author$project$Page2$Model = F2(
	function (key, message) {
		return {key: key, message: message};
	});
var author$project$Page2$init = function (key) {
	return _Utils_Tuple2(
		A2(author$project$Page2$Model, key, elm$core$Maybe$Nothing),
		author$project$Ports$ping('Page2'));
};
		...
		while (true) {
			if (_n0.$ === 'Just') {
				switch (_n0.a) {
					case 'page1':
						return A3(
							author$project$Main$transitTo,
							author$project$Main$Page1,
							author$project$Main$Page1Msg,
							author$project$Page1$init(key));
					case 'page2':
						return A3(
							author$project$Main$transitTo,
							author$project$Main$Page2,
							author$project$Main$Page2Msg,
							author$project$Page2$init(key));
					default:
						break _n0$2;
				}
			} else {
...
var author$project$Page1$Pong = function (a) {
	return {$: 'Pong', a: a};
};
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$Ports$pong = _Platform_incomingPort('pong', elm$json$Json$Decode$string);
var elm$core$Basics$identity = function (x) {
	return x;
};
var author$project$Page1$subscriptions = function (model) {
	return author$project$Ports$pong(author$project$Page1$Pong);
};
var author$project$Page2$Pong = function (a) {
	return {$: 'Pong', a: a};
};
var author$project$Page2$subscriptions = function (model) {
	return author$project$Ports$pong(author$project$Page2$Pong);
};
...
var author$project$Main$subscriptions = function (model) {
	if (model.$ === 'Page1') {
		...
		return A2(
			...
			author$project$Main$Page1Msg,
			author$project$Page1$subscriptions(subModel));
	} else {
		var subModel = model.a;
		return A2(
			elm$core$Platform$Sub$map,
			author$project$Main$Page2Msg,
			author$project$Page2$subscriptions(subModel));
	}
};
var elm$core$Platform$Cmd$batch = _Platform_batch;
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var author$project$Page1$update = F2(
	function (msg, model) {
		var message = msg.a;
		return _Utils_Tuple2(
			_Utils_update(
...
var author$project$Page2$update = F2(
	function (msg, model) {
		var message = msg.a;
		return _Utils_Tuple2(
			_Utils_update(
				...
				case 'Page1Msg':
					if (_n0.b.$ === 'Page1') {
						...
						return A3(
							...
							author$project$Main$Page1,
							author$project$Main$Page1Msg,
							A2(author$project$Page1$update, subMsg, subModel));
					} else {
						break _n0$4;
					}
				default:
					if (_n0.b.$ === 'Page2') {
						...
						return A3(
							...
							author$project$Main$Page2,
							author$project$Main$Page2Msg,
							A2(author$project$Page2$update, subMsg, subModel));
					} else {
						break _n0$4;
					}
			}
...
var author$project$Page1$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var author$project$Page2$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var author$project$Main$page = function (model) {
	if (model.$ === 'Page1') {
		...
		return A2(
			elm$html$Html$map,
			author$project$Main$Page1Msg,
			author$project$Page1$view(subModel));
	} else {
		var subModel = model.a;
		return A2(
			elm$html$Html$map,
			author$project$Main$Page2Msg,
			author$project$Page2$view(subModel));
	}
};
